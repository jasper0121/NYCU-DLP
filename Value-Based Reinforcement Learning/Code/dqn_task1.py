...
class DQNAgent:
    def __init__(self, env_name="CartPole-v1", args=None):
        ...
        # Initialize replay memory to store (state, action, reward, next_state, done)
    ...
    def run(self, episodes=1000):
        for ep in range(episodes):
            ...
            state = obs # Task1 doesn't need preprocessor
            done = False
            total_reward = 0
            step_count = 0
            ...
            while not done and step_count < self.max_episode_steps:
                ...
                next_state = next_obs # Task1 doesn't need preprocessor
    ...
    def evaluate(self):
        ...
        while not done:
            ...
            total_reward += reward
            state = next_obs # Task1 doesn't need preprocessor
    ...
    def train(self):
        ...
        loss = 0.5 * nn.MSELoss()(q_values, target)
